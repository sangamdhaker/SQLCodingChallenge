...
namespace ProjectManagementSystem
{
    class ProjectApp
    {
        static void Main(string[] args)
        {
            ...
            string connectionString = "Data Source=DESKTOP-JA7DIJC;Initial Catalog=PMSystem;Integrated Security=True;Encrypt=True;TrustServerCertificate=True"; // Replace with your actual connection string
